		...
		<div class="row">
			<div class="col-md-12">
				<div class="form_main">
					...
					<div class="form">
						<form action="/board/after_writing.board?board_code=${board_code}" method="post" id="contactFrm" name="contactFrm">
							<input type="text" class="text-1 form-control" style="margin-bottom:10px;" required placeholder=" 제목" id="title" name="writing_title" class="txt-1">
							<textarea class="txt-3" id="content" name="writing_content"></textarea>
							<div style="height:10px;"></div>
							<div class="row checkboxs">
								<div class="col-md-12w100-left">
						 ...
						 <input type="submit" value="submit" id="writing-btn" class="txt2">
						</form>
					</div>
				</div>
			</div>
